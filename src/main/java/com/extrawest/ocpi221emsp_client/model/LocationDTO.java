...
public class LocationDTO {
  ...
  public enum FacilitiesEnum {
    ...
    @SerializedName("CARPOOL_PARKING")
    ...
    public static class Adapter extends TypeAdapter<FacilitiesEnum> {
      ...
      public FacilitiesEnum read(final JsonReader jsonReader) throws IOException {
        ...
        return FacilitiesEnum.fromValue((String)(value));
      }
    }
  ...
  public enum ParkingTypeEnum {
    ...
    public static class Adapter extends TypeAdapter<ParkingTypeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ParkingTypeEnum enumeration) throws IOException {
        jsonWriter.value(String.valueOf(enumeration.getValue()));
      }

      @Override
      public ParkingTypeEnum read(final JsonReader jsonReader) throws IOException {
        Object value = jsonReader.nextString();
        return ParkingTypeEnum.fromValue((String)(value));
      }
    }
