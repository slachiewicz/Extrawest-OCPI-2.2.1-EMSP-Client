...
public class TariffRestrictions {
   ...
   */
  @JsonAdapter(ReservationEnum.Adapter.class)
  public enum ReservationEnum {
    @SerializedName("RESERVATION")
    RESERVATION("RESERVATION"),
    @SerializedName("RESERVATION_EXPIRES")
    ...
    public static class Adapter extends TypeAdapter<ReservationEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ReservationEnum enumeration) throws IOException {
        jsonWriter.value(String.valueOf(enumeration.getValue()));
      }

      @Override
      public ReservationEnum read(final JsonReader jsonReader) throws IOException {
        Object value = jsonReader.nextString();
        return ReservationEnum.fromValue((String)(value));
      }
    }
  }  @SerializedName("reservation")
